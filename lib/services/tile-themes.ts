...
export const CHILD_THEME_PRESETS: ChildThemePreset[] = [
  {
    ...
    primaryButton: "bg-gradient-to-r from-purple-600 to-pink-500 text-slate-950 shadow-purple-200",
  ...
  },
  {
    ...
    primaryButton: "bg-gradient-to-r from-pink-500 to-fuchsia-500 text-slate-950 shadow-pink-200",
  ...
  },
  {
    ...
    primaryButton: "bg-gradient-to-r from-green-600 to-emerald-500 text-slate-950 shadow-green-200",
  ...
  },
  {
    ...
    primaryButton: "bg-gradient-to-r from-emerald-600 to-lime-500 text-slate-950 shadow-emerald-200",
  ...
  },
  {
    ...
    primaryButton: "bg-gradient-to-r from-cyan-600 to-blue-500 text-slate-950 shadow-cyan-200",
