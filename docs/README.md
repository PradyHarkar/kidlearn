...
This folder is the source of truth for the content and learning experience contract.
...
If the generated question bank, UI, or test suite disagrees with these docs, the docs win.
